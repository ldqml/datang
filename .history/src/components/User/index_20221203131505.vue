    ...
    <div class="box1">
        ...
        <div class="bg">
            ...
            <div class="img4 active">
                ...
                <div class="img4-box2">
                    <p>宇辉电子为汽车电镀提供专属一站式表面处理方案，充分满足汽车零部件在功能使用，外观美化等多方面需求。</p>
                </div>
            </div>
            <div class="img5">
                 <p>航<br />天</p>
...
.img5{
    width: 220px;
    height: 540px;
    background-image: url("./images/未标题-5.png");
    opacity: 0.3;
}
.img5>p{
    font-size: 24px;
...
.img6{
    width: 220px;
    height: 540px;
    background-image: url("./images/未标题-6.png");
    opacity: 0.3;
}
.img6>p{
    font-size: 24px;
...
.img7{
    width: 220px;
    height: 540px;
    background-image: url("./images/未标题-7.png");
    opacity: 0.3;
}
.img7>p{
    font-size: 24px;
